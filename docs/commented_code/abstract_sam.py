...
from record_sam import RecordSam, SequenceRecordSam
...
class Reader(ABC):
    ...
    @abstractmethod
    def read(self) -> Iterator[RecordSam]:
        """
...
class SequenceReader(Reader):
    ...
    @abstractmethod
    def read(self) -> Iterator[SequenceRecordSam]:
        """
    ...
    @abstractmethod
    def get_sequence(self, seq: str, id: str) -> SequenceRecordSam:
        """
...
class GenomicDataReader(Reader):
    ...
    @abstractmethod
    def get_records_in_region(self, chrom: str, start: int, end: int) -> Iterator[RecordSam]:
        """
    ...
    @abstractmethod
    def filter_records(self, **filters) -> Iterator[RecordSam]:
        """
